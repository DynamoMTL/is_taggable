...
This fork works with Globalize3. It is currently missing Tag#name validations which needs to be resolved.
...
In addition, you can change the splitter and the joiner like so:

  IsTaggable::TagList.splitter = /,\s*/
  IsTaggable::TagList.joiner   = ', '

This way, even if the input has a lot of spaces, you can control the taglist to be nice and tidy.
